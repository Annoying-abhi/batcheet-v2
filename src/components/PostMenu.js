...
const PostMenu = ({ post, onBlock, onDelete, isAuthor }) => {
    ...
    return (
        <>
            <ReportModal isOpen={isReportModalOpen} onCancel={() => setIsReportModalOpen(false)} post={post} />
            <ConfirmModal 
            ...
            <div className="relative" ref={menuRef}>
                ...
                {isOpen && (
                    <div className="absolute top-full right-0 mt-2 w-48 bg-gray-700 border border-gray-600 rounded-lg shadow-lg z-10">
                                ...
                                <>
                                    <li>
                                        <button onClick={handleReport} className="w-full text-left px-4 py-2 text-sm text-yellow-400 hover:bg-gray-600 flex items-center gap-3">
                                            <AlertTriangle className="w-4 h-4" /> Report Post
                                        </button>
                                    </li>
                                    <li>
